...
$(document).ready(function () {
  console.log("HIHI");
  var version_selector = $(".docs-version-selector");
  var version_selector_select = $(".docs-version-selector select");

  version_selector_select.change(function (x) {
    target_href = version_selector_select.children("option:selected").get(0)
      .value;
